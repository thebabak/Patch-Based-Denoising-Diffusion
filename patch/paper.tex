...
Unless noted otherwise (final experiments with \texttt{patch260106.py}):
\begin{itemize}
...
Table~\ref{tab:fair_stats} compares real data on raw intensity scale (0--255), real data on training scale ($\approx[-1,1]$), and generated samples on the same training scale. This fair comparison prevents misleading conclusions from mismatched units.

A key finding is that the \texttt{bd} group has 100\% non-finite values, producing non-finite statistics. This can corrupt global $\mu,\sigma$ and explains why training logs can show repeated ``non-finite loss detected'' events. The result highlights that generative performance is inseparable from data integrity: a single corrupted subgroup can destabilise the entire pipeline.
...
\caption{Fair comparison of real and generated images on consistent scales. Real data are shown in raw intensity (0--255) and on the normalised training scale (approximately [-1,1]). Generated samples are on the training scale.}
...
REAL\_TRAIN\_SCALE\_-1\_1 & adhd & 40 & (40,128,128) & 0.0 & 0.0241 & 0.1916 & -0.2161 & 0.6754 & -0.1762 / 0.5839 \\
REAL\_RAW\_0\_255 & bd     & 49  & (49,128,128)  & 100.0 & NaN     & NaN     & NaN    & NaN      & NaN / NaN \\
REAL\_TRAIN\_SCALE\_-1\_1 & bd   & 49 & (49,128,128) & 100.0 & NaN    & NaN     & NaN    & NaN      & NaN / NaN \\
REAL\_RAW\_0\_255 & health & 121 & (121,128,128) & 0.0   & 59.1283 & 58.7890 & 0.0000 & 255.0000 & 6.1855 / 235.1145 \\
REAL\_TRAIN\_SCALE\_-1\_1 & health & 121 & (121,128,128) & 0.0 & -0.0094 & 0.2055 & -0.2161 & 0.6754 & -0.1944 / 0.6059 \\
REAL\_RAW\_0\_255 & schz   & 27  & (27,128,128)  & 0.0   & 63.5823 & 52.3887 & 0.0000 & 255.0000 & 11.2261 / 225.8346 \\
REAL\_TRAIN\_SCALE\_-1\_1 & schz & 27 & (27,128,128) & 0.0 & 0.0062 & 0.1831 & -0.2161 & 0.6754 & -0.1768 / 0.5734 \\
\midrule
GENERATED\_-1\_1 & sample\_epoch\_1  & 1 & (128,128) & 0.0 & 0.0092 & 0.1492 & -0.5472 & 0.6030 & -0.3327 / 0.3844 \\
GENERATED\_-1\_1 & sample\_epoch\_2  & 1 & (128,128) & 0.0 & 0.0064 & 0.1603 & -0.5880 & 0.6800 & -0.3704 / 0.3927 \\
GENERATED\_-1\_1 & sample\_epoch\_3  & 1 & (128,128) & 0.0 & 0.0017 & 0.1776 & -0.6901 & 0.6916 & -0.4206 / 0.4275 \\
GENERATED\_-1\_1 & sample\_epoch\_4  & 1 & (128,128) & 0.0 & -0.0068 & 0.1808 & -0.7177 & 0.6535 & -0.4286 / 0.4197 \\
GENERATED\_-1\_1 & sample\_epoch\_5  & 1 & (128,128) & 0.0 & -0.0038 & 0.1964 & -0.6956 & 0.6947 & -0.4609 / 0.4587 \\
GENERATED\_-1\_1 & sample\_epoch\_6  & 1 & (128,128) & 0.0 & -0.0204 & 0.1998 & -0.7150 & 0.6698 & -0.4864 / 0.4416 \\
GENERATED\_-1\_1 & sample\_epoch\_7  & 1 & (128,128) & 0.0 & -0.0157 & 0.1998 & -0.6981 & 0.6634 & -0.4753 / 0.4569 \\
GENERATED\_-1\_1 & sample\_epoch\_8  & 1 & (128,128) & 0.0 & -0.0261 & 0.2008 & -0.8862 & 0.6897 & -0.4935 / 0.4391 \\
GENERATED\_-1\_1 & sample\_epoch\_9  & 1 & (128,128) & 0.0 & -0.0139 & 0.2221 & -0.8228 & 0.7292 & -0.5280 / 0.5025 \\
GENERATED\_-1\_1 & sample\_epoch\_10 & 1 & (128,128) & 0.0 & -0.0143 & 0.2249 & -0.7653 & 0.7584 & -0.5428 / 0.5077 \\
GENERATED\_-1\_1 & sample\_final     & 1 & (128,128) & 0.0 & -0.0005 & 0.2193 & -0.8010 & 0.7293 & -0.5108 / 0.5057 \\
\bottomrule
\end{tabular}}
\end{table}
...
The repository includes scripts for patch-based training, sampling, logging of epoch-wise outputs, and utilities for dataset statistics and sanity checks (in particular, the \texttt{patch260106.py} training script used for the final reported run \texttt{runs\_patch260106}). We recommend recording the commit hash used for experiments (e.g., in the run folder) to ensure exact reproducibility.
